    ...
    <body>
        ...
        <section class="search-form">
            <form action="" method="post">
                <input type="text" name="search_box" placeholder="Tìm kiếm ngay" maxlength="100" class="box" required>
                        ...
                        if ($select_products->rowCount() > 0) {
                            while ($fetch_product = $select_products->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                <form action="" method="post" class="box">
                                    ...
                                    <input type="submit" value="Thêm vào giỏ hàng" class="btn" name="add_to_cart">
                                </form>
                                <?php
                            }
                        } else {
                            echo '<p class="empty">Không tìm thấy sản phẩm nào</p>';
                        }
                    }
                ?>
            </div>
